...
ActiveRecord::Schema[7.1].define(version: 2024_12_12_234500) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["from_id", "to_id", "created_at"], name: "index_messages_on_from_id_and_to_id_and_created_at"
    t.index ["from_id"], name: "index_messages_on_from_id"
    t.index ["to_id", "from_id", "created_at"], name: "index_messages_on_to_id_and_from_id_and_created_at"
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id", "created_at"], name: "index_orders_on_item_id_and_created_at"
